...
// // Add click event listener on tbody for all td cells except the last cell (actions)
// tbody.addEventListener("click", (e) => {
//   const td = e.target.closest("td");
//   if (!td) return;

//   const tr = td.closest("tr");
//   if (td.cellIndex === tr.cells.length - 1) return; // ignore action cell
...
//   // Replace this cell content with input
...
//     saveInputValue(td, input);
//   });
//   input.addEventListener("keydown", (event) => {
//     if (event.key === "Enter") {
//       input.blur(); // triggers save
//     } else if (event.key === "Escape") {
//       td.textContent = originalText; // cancel edit
//     }
//   });
// });

// Helper function to save input value back to td
// function saveInputValue(td, input) {
//   const newValue = input.value.trim();
//   if (newValue === "") {
//     alert("Cell value cannot be empty!");
//     input.focus();
//     return;
//   }
